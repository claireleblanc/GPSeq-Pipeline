...
docker cp ./main_mouse.sh gpseq_container:/home
...
do
    ...
    echo ${sample}
    echo ${barcode}
    docker exec gpseq_container bash /home/main_mouse.sh ${run_id} ${sample} 20 ${barcode}
done < "$input"
...
docker cp ./B319_centrality_GPSeq_meta.tsv gpseq_container:/home

outpath="/home/${run_id}/radical-out-gpseq"
metadata="/home/B319_centrality_GPSeq_meta.tsv"
