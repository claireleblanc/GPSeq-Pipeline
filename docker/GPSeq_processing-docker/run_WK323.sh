...
do
    ...
    echo ${sample}
    echo ${barcode}
    docker exec gpseq_container_${run_id} bash /home/main_human.sh ${run_id} ${sample} 20 ${barcode}
done < "$input"
